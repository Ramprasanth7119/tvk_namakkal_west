...
export default function AnalyticsDashboard() {
  ...
  useEffect(() => {
    ...
    const handleMouseOver = (e: MouseEvent) => {
      ...
      if (hoverEl && clabel) {
        clabel.textContent = hoverEl.dataset.clabel || hoverEl.closest('[data-clabel]')?.getAttribute('data-clabel') || t('analytics.touch');
      }
    };
  ...
  return (
    <div className="analytics-body">
      ...
      <div className="wcur" id="wcur">
        ...
        <span className="clabel" id="clabel">{t("analytics.touch")}</span>
      </div>
    </div>
  );
}
